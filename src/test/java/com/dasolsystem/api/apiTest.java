...
public class apiTest {
    ...
    void login(){
        String refresh = jwtBuilder.generateRefreshToken("testUser");
    ...
    public void TestValidToken(){
        ...
        String token2 = jwtBuilder.generateRefreshToken("testUser");
    ...
    public void TestAccessToken(){
        ...
        String refreshToken = jwtBuilder.generateRefreshToken("testUser");
        jwtBuilder.saveRefreshToken(signInJwtBuilderDto.builder() //DB에 이름을 키로 한 리프레시 토큰 저장
                .userName("testUser")
